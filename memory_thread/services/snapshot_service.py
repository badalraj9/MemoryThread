...
class SnapshotService:
    ...
    def get_latest_snapshot(
        self, entity_id: uuid.UUID, before_time: Optional[datetime] = None
    ...
    def get_nearest_snapshot(
        ...
        """
        Get the nearest snapshot before the given timestamp for timewarp replay.
        """
        query = """
            SELECT entity_id, last_event_id, state_data, truth_vector, timestamp
            FROM snapshots
        ...
        return self._row_to_entity_state(row, entity_id)
