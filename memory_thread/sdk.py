...
class _SlabIngestPipeline:
    ...
    def __init__(
        ...
        self._threads = [
            threading.Thread(
                ...
                name=f"mt-slab-ingest-{owner.namespace}-{index}",
                daemon=True,
            )
    ...
    def _drain_loop(self) -> None:
        ...
        try:
            ...
            wal = get_wal(self.owner.namespace)
        ...
        while True:
            ...
            wal_sequences: List[Optional[int]]
...
class MemoryClient:
    ...
    def _remember_direct(
        ...
        if wal_seq is not None and not wal_prewritten:
            try:
                from memory_thread.services.wal import get_wal
